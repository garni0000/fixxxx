    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold mb-1">Pronos du jour</h1>
          ...
          <div className="flex gap-2">
            <Link to="/pronos/yesterday">
              <Button variant="outline" size="sm" className="text-xs">Hier</Button>
            </Link>
        ...
        {totalLockedCount > 0 && (
          <Card className="mb-4 p-3 sm:p-4 bg-primary/5 border-primary/20">
            <div className="flex items-center gap-3">
              ...
              <Link to="/pricing">
                <Button variant="default" size="sm" className="text-xs" data-testid="button-upgrade">Débloquer</Button>
              </Link>
            </div>
          </Card>
        )}
